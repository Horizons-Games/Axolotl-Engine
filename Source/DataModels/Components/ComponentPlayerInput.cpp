...
const std::map<SDL_GameControllerButton, SDL_Scancode> defaultGamepadMapping = {
	...
	// L has to be used everywhere as left mouse button
	// because this map cannot hold mouse buttons
	{ SDL_CONTROLLER_BUTTON_B, SDL_SCANCODE_L },
	{ SDL_CONTROLLER_BUTTON_X, SDL_SCANCODE_E },
	{ SDL_CONTROLLER_BUTTON_Y, SDL_SCANCODE_ESCAPE },
	...
	{ SDL_CONTROLLER_BUTTON_DPAD_UP, SDL_SCANCODE_ESCAPE },
	{ SDL_CONTROLLER_BUTTON_DPAD_DOWN, SDL_SCANCODE_ESCAPE },
	{ SDL_CONTROLLER_BUTTON_DPAD_LEFT, SDL_SCANCODE_ESCAPE },
	{ SDL_CONTROLLER_BUTTON_DPAD_RIGHT, SDL_SCANCODE_ESCAPE },
