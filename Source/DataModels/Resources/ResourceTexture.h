...
{
public:
	ResourceTexture(int resourceUUID, const std::string& assetsPath, const std::string& libraryPath);
...
inline ResourceTexture::ResourceTexture(int resourceUUID,
										const std::string& assetsPath,
										const std::string& libraryPath) :
	Resource(resourceUUID, assetsPath, libraryPath)
{
}
