...
public:
	...
	const float4& GetOldDiffuseColor();
	...
	void SetOldDiffuseColor(float4& diffuseColor);
...
inline const float4& ResourceMaterial::GetOldDiffuseColor()
{
...
inline void ResourceMaterial::SetOldDiffuseColor(float4& diffuseColor)
{
