...
samplerCube diffuse_IBL, samplerCube prefiltered_IBL, sampler2D environmentBRDF, int numLevels_IBL, float intensity)
{
    ...
    return (diffuse * irradiance + radiance * (specularColor * fab.x + fab.y)) * intensity;
}
